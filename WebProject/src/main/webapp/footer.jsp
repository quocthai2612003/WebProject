    ...
    <div class="row">
        ...
        <div class="col-6 col-md-2 mb-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Chính sách khách hàng</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Chính sách bảo mật</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Chính sách vận chuyển và thanh toán</a></li>
        ...
        <div class="col-md-5 offset-md-1 mb-3">
            <form>
                ...
                <p>Nhận ngay thông tin về sản phẩm mới và các chương trình ưu đãi!</p>
                <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                    <label for="newsletter1" class="visually-hidden">Email address</label>
                    <input id="newsletter1" type="text" class="form-control" placeholder="Nhập email của bạn">
                    <button class="btn btn-warning col-md-2" type="button">Đăng kí</button>
                </div>
            </form>
        </div>
    </div>

    <div class="d-flex flex-sm-row flex-column justify-content-between py-2 my-4 border-top bg-white">
        <p>&copy; 2023 PQL, Inc. All rights reserved.</p>
        <ul class="list-unstyled d-flex">
            <li class="ms-0"><a class="link-dark" href="#"><i class="fa-brands fa-github fa-2xl"></i></a></li>
